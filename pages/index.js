...
const page = () => {
  ...
  const handleContinue = () => {
    ...
    navigate.push(`/signup-password?username=${value}`);
  };
        ...
        <div className="w-[88%] bg-white flex justify-between p-8 md:p-16 lg:p-20 rounded-[50px]  flex-col md:flex-row">
          ...
          <div className="flex items-center md:items-end justify-center flex-col gap-6 w-full md:w-1/2">
            <div className="relative w-full ">
              ...
              <label
                ...
                className={`absolute left-6 md:left-8 top-4 md:top-6 text-[#636363] font-semibold transition-all duration-300 ${
                  isFocused || value
                    ? "scale-90 -translate-y-6 md:-translate-y-10  text-sm md:text-2xl z-50 bg-white"
            ...
            <button
              ...
              className="bg-black text-sm md:text-2xl rounded-lg md:p-4 md:px-8 p-2 px-6 font-[800] text-white md:flex justify-center items-center hidden"
            >
              Continue
            </button>
            ...
            <div className="flex justify-between md:hidden items-center w-full mb-12">
              ...
              <button
                onClick={handleContinue}
                className="bg-black text-sm md:text-2xl rounded-lg md:p-4 md:px-8 p-2 px-6 font-[800] text-white flex justify-center items-center "
              >
                Continue
              </button>
            </div>
